...
interface PatDef {
  id:string; docIdx:number; fn:string; ln:string; dob:string; gender:string;
...
const PATIENTS: PatDef[] = [
  { id: '66c67bf7-f6e3-478e-b972-20d7d25b4958', docIdx:0, fn:'Ravi', ln:'Kumar', dob:'1950-03-15', gender:'Male', phone:'+91-98765-43210', addr:'HSR Layout, Bangalore, Karnataka', email:'ravi.kumar@careguardian.health', ec:{n:'Ananya Kumar',p:'+91-98765-00001'},
  ...
  { id: '33ec2506-2cfd-437d-8c66-defd67159f29', docIdx:0, fn:'Sunita', ln:'Balasubramanian', dob:'1948-11-22', gender:'Female', phone:'+91-96300-78901', addr:'Koramangala, Bangalore', email:'sunita.balasubramanian@careguardian.health', ec:{n:'Karthik Balasubramanian',p:'+91-96300-00002'},
  ...
  { id: 'a9f1ca74-032e-465f-b153-54365602c4ca', docIdx:0, fn:'Gopalan', ln:'Rajan', dob:'1943-07-08', gender:'Male', phone:'+91-94440-11223', addr:'Malleswaram, Bangalore', email:'gopalan.rajan@careguardian.health', ec:{n:'Kavitha Rajan',p:'+91-94440-00003'},
  ...
  { id: 'eaf97dad-41d4-4e48-a345-5f1d3f0f5380', docIdx:1, fn:'Lakshmi', ln:'Raghavan', dob:'1948-07-22', gender:'Female', phone:'+91-98400-55667', addr:'Adyar, Chennai', email:'lakshmi.raghavan@careguardian.health', ec:{n:'Suresh Raghavan',p:'+91-98400-00004'},
  ...
  { id: '3489a162-e878-493a-92e3-ad33476afc55', docIdx:1, fn:'Mohan', ln:'Pillai', dob:'1944-11-08', gender:'Male', phone:'+91-94470-22334', addr:'Trivandrum, Kerala', email:'mohan.pillai@careguardian.health', ec:{n:'Shyam Pillai',p:'+91-94470-00005'},
  ...
  { id: '2275974a-33b5-4f1d-aa97-79b60c26893e', docIdx:1, fn:'Kamala', ln:'Venkatesh', dob:'1952-02-14', gender:'Female', phone:'+91-99000-45678', addr:'Mysuru, Karnataka', email:'kamala.venkatesh@careguardian.health', ec:{n:'Vinod Venkatesh',p:'+91-99000-00006'},
  ...
  { id: '5b29040a-ea76-4cf3-9d2c-f63c70fcd419', docIdx:2, fn:'Krishnamurthy', ln:'Swaminathan', dob:'1941-05-30', gender:'Male', phone:'+91-97890-33445', addr:'T. Nagar, Chennai', email:'krishnamurthy.swaminathan@careguardian.health', ec:{n:'Uma Swaminathan',p:'+91-97890-00007'},
    dementiaStage: 'FAST Stage 6: Moderately Severe Decline',
    ...
    allergies:[],
    meds:[
      {name:'Donepezil 10mg',gen:'donepezil',dose:'10 mg',freq:'once nightly',since:'2020-02-01',by:'Dr. Meera Pillai'},
      {name:'Memantine 10mg',gen:'memantine',dose:'10 mg',freq:'twice daily',since:'2021-03-01',by:'Dr. Meera Pillai'},
      {name:'Metformin 500mg',gen:'metformin',dose:'500 mg',freq:'twice daily',since:'2008-12-01',by:'Dr. Meera Pillai'},
      {name:'Oxybutynin 5mg',gen:'oxybutynin',dose:'5 mg',freq:'three times daily',since:'2022-01-10',by:'Dr. Meera Pillai',note:'High anticholinergic burden'},
      {name:'Lorazepam 0.5mg',gen:'lorazepam',dose:'0.5 mg',freq:'as needed for agitation',since:'2022-03-01',by:'Dr. Meera Pillai',note:'Benzodiazepine risk'}
    ],
  ...
  { id: 'f400c4b2-e9be-4223-ac3a-342868fd48d6', docIdx:2, fn:'Radha', ln:'Krishnan', dob:'1946-09-03', gender:'Female', phone:'+91-98510-66789', addr:'Coimbatore, Tamil Nadu', email:'radha.krishnan@careguardian.health', ec:{n:'Arun Krishnan',p:'+91-98510-00008'},
  ...
  { id: '95007ae1-f846-4543-9446-5bdf68ddfd32', docIdx:2, fn:'Balaji', ln:'Subramaniam', dob:'1955-12-25', gender:'Male', phone:'+91-94880-12345', addr:'Velachery, Chennai', email:'balaji.subramaniam@careguardian.health', ec:{n:'Meena Subramaniam',p:'+91-94880-00009'},
  ...
  { id: 'd47beac5-3a09-4722-94bf-7cae9f8a081f', docIdx:3, fn:'Padmanabhan', ln:'Nambiar', dob:'1939-04-17', gender:'Male', phone:'+91-96000-98765', addr:'Kozhikode, Kerala', email:'padmanabhan.nambiar@careguardian.health', ec:{n:'Sridevi Nambiar',p:'+91-96000-00010'},
  ...
  { id: '12d12b80-9848-4130-89ba-10f6334c6899', docIdx:3, fn:'Janaki', ln:'Srinivasan', dob:'1953-06-10', gender:'Female', phone:'+91-90000-23456', addr:'Thrissur, Kerala', email:'janaki.srinivasan@careguardian.health', ec:{n:'Manohar Srinivasan',p:'+91-90000-00011'},
  ...
  { id: 'a54594c5-bf6f-4f0b-bcca-b3df6ce952c6', docIdx:3, fn:'Venkatasubramanian', ln:'Iyer', dob:'1936-01-01', gender:'Male', phone:'+91-98660-34567', addr:'Ernakulam, Kerala', email:'venkatasubramanian.iyer@careguardian.health', ec:{n:'Geetha Iyer',p:'+91-98660-00012'},
  ...
  { id: 'ea413a16-5149-4dd9-905b-d3f62508e931', docIdx:4, fn:'Nalini', ln:'Chandrasekhar', dob:'1958-08-19', gender:'Female', phone:'+91-94440-56789', addr:'Mandya, Karnataka', email:'nalini.chandrasekhar@careguardian.health', ec:{n:'Pradeep Chandrasekhar',p:'+91-94440-00013'},
  ...
  { id: 'e442022e-1232-4ccb-b5bc-c6b3bbcc67cb', docIdx:4, fn:'Shanmugam', ln:'Palanichamy', dob:'1947-03-27', gender:'Male', phone:'+91-96000-67890', addr:'Madurai, Tamil Nadu', email:'shanmugam.palanichamy@careguardian.health', ec:{n:'Kavitha Palanichamy',p:'+91-96000-00014'},
  ...
  { id: '3a681eb3-f656-48ae-ba48-353c5f0a8a4f', docIdx:4, fn:'Bhagyalakshmi', ln:'Narayanan', dob:'1961-10-05', gender:'Female', phone:'+91-98760-78901', addr:'Tirunelveli, Tamil Nadu', email:'bhagyalakshmi.narayanan@careguardian.health', ec:{n:'Ganesh Narayanan',p:'+91-98760-00015'},
...
async function seedPatientsAndCaregivers(doctorIds: string[], adminId: string) {
  ...
  for (const pd of PATIENTS) {
    ...
    const pu = await prisma.user.upsert({
      ...
      create:{id:pd.id,email:pd.email,name:pd.fn+' '+pd.ln,passwordHash,roles:['PATIENT']}
    });
    const patient = await prisma.patient.upsert({
      where:{id:pu.id}, update:{},
      create:{id:pu.id,firstName:pd.fn,lastName:pd.ln,dateOfBirth:dateOf(pd.dob),gender:pd.gender,phone:pd.phone,email:pd.email,address:pd.addr,emergencyContactName:pd.ec.n,emergencyContactPhone:pd.ec.p,timezone:'Asia/Kolkata',preferredLanguage:'en',dementiaStage:pd.dementiaStage||null,createdById:adminId}
    });
